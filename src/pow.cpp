...
{
    /* current difficulty formula, rpd - DarkGravity v3, written by Evan Duffield - evan@dashpay.io */
    ...
    if (bnNew > Params().GetConsensus().powLimit) {
        bnNew = Params().GetConsensus().powLimit;
    }

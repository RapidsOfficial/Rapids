    ...
    ui(new Ui::PrivacyWidget)
{
    ...
    ui->btnTotalzPIV->setTitleClassAndText("btn-title-grey", "Total 0 zRPD");
    ui->btnTotalzPIV->setSubTitleClassAndText("text-subtitle", "Show denominations of zRPD owned.");

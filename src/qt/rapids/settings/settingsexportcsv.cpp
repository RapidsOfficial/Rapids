...
#include "qt/rapids/settings/forms/ui_settingsexportcsv.h"
#include <QFile>
...
SettingsExportCSV::SettingsExportCSV(RapidsGUI* _window, QWidget *parent) :
...
void SettingsExportCSV::selectFileOutput(const bool& isTxExport)
{
    QString filename = GUIUtil::getSaveFileName(this,
                                        ...
                                        isTxExport ? tr("Rapids_tx_csv_export(*.csv)") : tr("Rapids_addresses_csv_export(*.csv)"),
                                        nullptr);

...
#include "qt/rapids/settings/forms/ui_settingsfaqwidget.h"
#include <QScrollBar>
#include <QMetaObject>
#include "qt/rapids/qtutils.h"

SettingsFaqWidget::SettingsFaqWidget(RapidsGUI *parent) :
    QDialog(parent),
    ui(new Ui::SettingsFaqWidget)
{
    ...
    // Web Link
    ui->pushButtonWebLink->setText("https://RPD.org/");
    ...
    if (parent)
        connect(parent, &RapidsGUI::windowResizeEvent, this, &SettingsFaqWidget::windowResizeEvent);
}

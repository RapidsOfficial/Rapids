...
#include "qt/rapids/settings/forms/ui_settingsconsolewidget.h"
...
#include "qt/rapids/settings/moc_settingsconsolewidget.cpp"
...
SettingsConsoleWidget::SettingsConsoleWidget(RapidsGUI* _window, QWidget *parent) :

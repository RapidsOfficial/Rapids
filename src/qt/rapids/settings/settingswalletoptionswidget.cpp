...
#include "qt/rapids/settings/forms/ui_settingswalletoptionswidget.h"
#include <QListView>
#include "optionsmodel.h"
#include "clientmodel.h"
#include "qt/rapids/qtutils.h"

SettingsWalletOptionsWidget::SettingsWalletOptionsWidget(RapidsGUI* _window, QWidget *parent) :

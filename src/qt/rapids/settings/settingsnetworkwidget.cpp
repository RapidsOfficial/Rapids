...
#include "qt/rapids/settings/settingsnetworkwidget.h"
#include "qt/rapids/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/rapids/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(RapidsGUI* _window, QWidget *parent) :

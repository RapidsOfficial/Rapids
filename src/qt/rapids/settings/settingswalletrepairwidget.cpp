...
#include "qt/rapids/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/rapids/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(RapidsGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to RapidsGUI::handleRestart()

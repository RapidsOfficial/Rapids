...
#include "qt/rapids/forms/ui_sendcustomfeedialog.h"
...
SendCustomFeeDialog::SendCustomFeeDialog(RapidsGUI* parent, WalletModel* model) :
    ...
    walletModel(model)
{
    ...
    if (parent)
        connect(parent, &RapidsGUI::themeChanged, this, &SendCustomFeeDialog::onChangeTheme);

...
#include "qt/rapids/forms/ui_masternodeswidget.h"

#include "qt/rapids/qtutils.h"
#include "qt/rapids/mnrow.h"
#include "qt/rapids/mninfodialog.h"
#include "qt/rapids/masternodewizarddialog.h"
...
MasterNodesWidget::MasterNodesWidget(RapidsGUI *parent) :
    PWidget(parent),
...
void MasterNodesWidget::onCreateMNClicked()
{
    ...
    if (walletModel->getBalance() <= 10000000 * COIN) {
        inform(tr("Not enough balance to create a masternode, 10,000,000 RPD required."));
        return;
    }
    showHideOp(true);

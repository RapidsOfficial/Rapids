...
bool RapidsGUI::openStandardDialog(QString title, QString body, QString okBtn, QString cancelBtn)
{
    ...
    if (isVisible()) {
        ...
        dialog->setWindowTitle(tr("Rapids Core"));
        dialog->adjustSize();
        dialog->raise();
        dialog->exec();
    }
...
void RapidsGUI::unsubscribeFromCoreSignals()
{
    ...
    uiInterface.ThreadSafeMessageBox.disconnect(std::bind(ThreadSafeMessageBox, this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3));
}

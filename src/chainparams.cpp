...
public:
    CMainParams()
    {
        ...
        // validation by-pass
        consensus.nRapidsBadBlockTime = disabled;
        consensus.nRapidsBadBlockBits = 0x1c056dac;
...
public:
    CTestNetParams()
    {
        ...
        // validation by-pass
        consensus.nRapidsBadBlockTime = 1489001494; // Skip nBit validation of Block 201 per PR #915
        consensus.nRapidsBadBlockBits = 0x1e0a20bd; // Skip nBit validation of Block 201 per PR #915
        ...
        vSeeds.push_back(CDNSSeedData("warrows.dev", "testnet.dnsseed.rapids.warrows.dev"));

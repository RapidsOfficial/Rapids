...
"""Verify that starting rapids with -h works as expected."""
import subprocess

from test_framework.test_framework import RapidsTestFramework
from test_framework.util import assert_equal

class HelpTest(RapidsTestFramework):
    ...
    def run_test(self):
        self.log.info("Start rapids with -h for help text")
        ...
        self.log.info("Start rapids with -version for version information")

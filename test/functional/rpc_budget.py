...
class BudgetProposalTest(RapidsTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Test with invalid Rapids address")
        assert_raises_rpc_error(-5, "Invalid Rapids address", self.nodes[0].preparebudget,

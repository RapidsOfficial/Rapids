...
from test_framework.rapids_node import RapidsTestNode
...
class Rapids_ColdStakingTest(RapidsTestFramework):
    ...
    def init_test(self):
        ...
        for i in range(self.num_nodes):
            self.test_nodes.append(RapidsTestNode())

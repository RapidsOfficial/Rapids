...
RESOURCES += src/qt/rapids.qrc src/qt/rapids_locale.qrc

TRANSLATIONS += src/qt/locale/rapids_bg.ts \
                src/qt/locale/rapids_de.ts \
                src/qt/locale/rapids_en.ts \
                src/qt/locale/rapids_es.ts \
                src/qt/locale/rapids_fi.ts \
                src/qt/locale/rapids_fr.ts \
                src/qt/locale/rapids_it.ts \
                src/qt/locale/rapids_ja.ts \
                src/qt/locale/rapids_pl.ts \
                src/qt/locale/rapids_pt.ts \
                src/qt/locale/rapids_ru.ts \
                src/qt/locale/rapids_sk.ts \
                src/qt/locale/rapids_sv.ts \
                src/qt/locale/rapids_vi.ts \
                src/qt/locale/rapids_zh_CN.ts \
                src/qt/locale/rapids_zh_TW.ts

...
#   c) node1 mines 32 blocks, so now node 0 has 500000RPD, node 1 has 4250RPD, node2 has none.
#   d) node0 sends 601 RPD to node2, in two transactions (301 RPD, then 300 RPD).

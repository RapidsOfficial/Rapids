...
In order to support loading of multiple wallets in rapids-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is rapids.cpp.
...
Changes to rapids.cpp
----------------------
rapids.cpp is the entry point into rapids-qt, and as such, will require some minor modifications to provide hooks for

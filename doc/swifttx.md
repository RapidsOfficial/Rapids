...
This mechanism has been integrated into Bitcore-Node-Rapids which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/rapids/insight-api-rapids#web-socket-api](https://github.com/rapids/insight-api-rapids#web-socket-api)
* API: [https://github.com/rapids/insight-api-rapids#swifttx-transactions](https://github.com/rapids/insight-api-rapids#swifttx-transactions)
...
By default, the Rapids Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Rapids Core daemon:
